...
- The stair (t8–t10) is done; its holds are the near side's reads. t11: dead
  ...
  **78px** in t12's exact swell, landing step 1 = the touch, hold **27px**.
  t19: far side re-walks s1's opening EXACTLY (rhythm and stride), +5326,
  landing (5464,286) = s1's pause height. t20: far
  ...
  **10th widening 5760→6400**. t21: the far side takes s1's post-pause shape
  ...
  final step 7), breath **(6400,241)**, **11th widening 6400→7040**. t23:
  the roll, taken — first move off a breath returns to the height
